    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="flex items-center justify-start">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="{{ asset('images/logo.png') }}"
                            alt="Logo GestoCar"
                            class="h-16 w-auto mr-3 scale-125 object-contain relative top-1">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-6">
                ...
                <!-- Notificações -->
                <div class="relative">
                    <a href="{{ route('notificacao.index') }}" class="relative inline-flex items-center text-gray-500 hover:text-gray-700 focus:outline-none">
                        🔔
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 border-t border-gray-200 pt-3">
                <x-responsive-nav-link :href="route('notificacao.index')">
                    🔔 Notificações
                    @if(isset($notificacoesPendentes) && $notificacoesPendentes > 0)
